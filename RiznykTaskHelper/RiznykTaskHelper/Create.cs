    ...
    public partial class Create : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (tabControl1.SelectedIndex == 0)
            {
                ...
                {
                    Task newTask = new Task() { Name = textBox1.Text, Description = richTextBox1.Text };
            ...
            if (tabControl1.SelectedIndex == 1)
            {
                ...
                if (dialog == DialogResult.OK)
                {
                    Reminding newReminding = new Reminding() { Name = textBox2.Text, Description = richTextBox2.Text, Date = dateTimePicker1.Value };
