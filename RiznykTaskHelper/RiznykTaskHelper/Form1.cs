...
namespace RiznykTaskHelper
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            {
                if (remindingsList[i].Date.ToString("MM/dd/yyyy") == DateTime.Today.ToString("MM/dd/yyyy"))
                {
        ...
        public void DataGrindLoad()
        {
            ...
            {
                dataGridView1.Rows.Add(tasksList[i].Name);
            }
            for (int i = 0; i < remindingsList.Count; i++)
            {
                dataGridView2.Rows.Add(remindingsList[i].Date, remindingsList[i].Name);
            }
        }
